...
- Que tan acertada es la percepción de las personas sobre su genero favorito?
	Para este ultimo vamos a extraer la intencidad promedio de los generos más populares del siguiente [estudio]( https://github.com/isaackwy/loudness-wars-spotify)
